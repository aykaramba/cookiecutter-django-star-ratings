...
from proj_tut15_ratings.users.models import User
from proj_tut15_ratings.users.tests.factories import UserFactory
from proj_tut15_ratings.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
